...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td class="footer" width="20%"></td>
        <td class="footer" style="vertical-align:top;align:left;">Licensed under the <a href="http://www.openclinica.com/gnu-lgpl-open-source-license" target="_blank">GNU Lesser General Public License</a> as published by the Free Software Foundation. <a href="http://www.openclinica.com/trademark" target="_blank">OpenClinica</a> is a trademark of OpenClinica, LLC.</td>
        <td width="20%" class="footer" style="vertical-align:top;align:left;">OpenClinica Rules Designer<br><fmt:message key="Version_release" bundle="${licensing}"/></td>
        <td width="10%" valign="bottom"></td>
    </tr>
    <tr>
        <td class="footer" width="20%"></td>
        <td class="footer"></td>
        <td width="10%" class="footer"></td>
