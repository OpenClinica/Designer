    ...
    function addNotificationAction (toolExpressionEvaluatesTo,tooltipTo,tooltipSubject,tooltipMessage) {
        var nameAttrOLlazyNotificationActions =  $("textarea[name*=lazyNotificationActions]").last().attr("id");
            ...
            $("#ruleActions").append(
             ...
             + "<div style=\"height: 25px;\" class=\"background_button_div\"><div style=\"opacity: 0.6;\" id=\"to_div-" +index+ "\" ><span id=\"to_participant-" + index  + "\" class=\"participantBtn ui-button span_btn\" style=\"margin-left: 3px;\">Participant</span><\/div><\/div>"
             + "<input type=\"text\" value=\"\" name=\"ruleRef.lazyNotificationActions[" + index  + "].to\" id=\"ruleRef.lazyNotificationActions" + index  + ".to\" title=\"" + tooltipTo + "\" class=\"notifToInput notif_input\" > "
             ...
             + "<div style=\"opacity: 0.6;\" id=\"subject_div-" + index + "\">"
             + "<span id=\"subject_study-" + index  + "\" class=\"studyBtn ui-button span_btn\" style=\"margin-left: 10px; vertical-align: top;\">Study</span>"
             + "<span id=\"subject_event-" + index  + "\" class=\"eventBtn ui-button span_btn\" style=\"margin-left: 10px; vertical-align: top;\">Event</span>"
             + "<img src=\"includes/img/vertical_white.png\" class=\"img_divider\">"
             + "<span id=\"subject_participant-" + index  + "\" class=\"participantBtn ui-button span_btn\" style=\"margin-left: 10px; vertical-align: top;\">Participant</span>"
             + "<span id=\"subject_fName-" + index  + "\" class=\"fNameBtn ui-button span_btn\" style=\"margin-left: 8px; vertical-align: top;\">First Name</span>"
             + "<span id=\"subject_url-" + index  + "\" class=\"urlBtn ui-button span_btn\" style=\"margin-left: 8px; vertical-align: top;\">URL</span>"
             + "<span id=\"subject_urlLogin-" + index  + "\" class=\"urlLoginBtn ui-button span_btn\" style=\"margin-left: 8px; vertical-align: top;\">URL+Login</span>"
             + "<span id=\"subject_accessCode-" + index  + "\" class=\"accessCodeBtn ui-button span_btn\" style=\"margin-left: 8px; vertical-align: top;\">Access Code</span>"
             + "<\/div><\/div>"
             + "<input type=\"text\" value=\"\" name=\"ruleRef.lazyNotificationActions[" + index  + "].subject\" id=\"ruleRef.lazyNotificationActions" + index  + ".subject\" title=\"" + tooltipSubject + "\" class=\"notifSubjectInput notif_input\" > "
             + "<\/p><p class=\"margin_left_notif\">"
             ...
             + "<\/div>"
             + "<div class=\"background_button_div\">"
             + "<div style=\"opacity: 0.6;\" id=\"message_div-" + index + "\">"
             + "<span id=\"message_study-" + index  + "\" class=\"studyBtn ui-button span_btn\" style=\"margin-left: 10px; vertical-align: top;\">Study</span>"
             + "<span id=\"message_event-" + index  + "\" class=\"eventBtn ui-button span_btn\" style=\"margin-left: 10px; vertical-align: top;\">Event</span>"
             + "<img src=\"includes/img/vertical_white.png\" class=\"img_divider\">"
             + "<span id=\"message_participant-" + index  + "\" class=\"participantBtn ui-button span_btn\" style=\"margin-left: 10px; vertical-align: top;\">Participant</span>"
             + "<span id=\"message_fName-" + index  + "\" class=\"fNameBtn ui-button span_btn\" style=\"margin-left: 8px; vertical-align: top;\">First Name</span>"
             + "<span id=\"message_url-" + index  + "\" class=\"urlBtn ui-button span_btn\" style=\"margin-left: 8px; vertical-align: top;\">URL</span>"
             + "<span id=\"message_urlLogin-" + index  + "\" class=\"urlLoginBtn ui-button span_btn\" style=\"margin-left: 8px; vertical-align: top;\">URL+Login</span>"
             + "<span id=\"message_accessCode-" + index  + "\" class=\"accessCodeBtn ui-button span_btn\" style=\"margin-left: 8px; vertical-align: top;\">Access Code</span><\/div><\/div>"
             + "<textarea cols=\"50\" rows=\"3\" name=\"ruleRef.lazyNotificationActions[" + index  + "].message\" id=\"ruleRef.lazyNotificationActions" + index  + ".message\" title=\"" + tooltipMessage + "\" style=\"width: 586px; height: 150px;\" class=\"notifMessageInput notif_input\"><\/textarea>"
             + "<\/p>"
             + "<\/fieldset>"
             + "<\/span>"
             );
